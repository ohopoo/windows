/**
 * Created by TuDinhTan on 5/25/17.
 */
...
function restack(horizontal) {
    ...
    if (horizontal) {
        ...
        stack = " horizontal";
        document.getElementById("textareacontainer").style.height = "40%";
        document.getElementById("iframecontainer").style.height = "60%";
        ...
        document.getElementById("textareacontainer").style.width = "40%";
        document.getElementById("iframecontainer").style.width = "60%";
        currentStack = true;
    }
    fixDragBtn();
    // showFrameSize();
